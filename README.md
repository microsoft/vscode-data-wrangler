...
>
> _* We use the Python `re` module in order to support Unicode characters classes to simplify complex expressions, since Python's regex module doesn't support it._
